...
ggsave("results/analysis4_SVA_unadjusted.png", plot = p1, width = 8, height = 6, dpi = 300)
cat("\nSaved unadjusted plot to results/analysis4_SVA_unadjusted.png\n")
...
ggsave("results/analysis4_SVA_adjusted.png", plot = p2, width = 8, height = 6, dpi = 300)
cat("Saved adjusted (residual) plot to results/analysis4_SVA_adjusted.png\n")
...
ggsave("results/analysis4_SVA_coefficient_comparison.png", plot = p3, width = 8, height = 6, dpi = 300)
cat("Saved coefficient comparison plot to results/analysis4_SVA_coefficient_comparison.png\n")
